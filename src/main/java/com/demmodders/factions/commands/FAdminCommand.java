...
public class FAdminCommand extends CommandBase {
    ...
    private String printHelp(int Page, boolean dump) throws IndexOutOfBoundsException {
        ...
        if (commands != null) {
            ...
            for (int i = firstIndex + 1; i < commands.size() && i < lastIndex; i++) {
                ...
                if (dump) helpText.append("/factionadmin ");
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        if(args.length == 0){
            ...
            if (PermissionAPI.hasPermission((EntityPlayerMP) sender, "demfactions.admin")) {
                ...
                switch (args[0].toLowerCase()) {
                    ...
                    case "flag":
                        if (args.length > 3) {
                            ...
                            replyMessage = DemConstants.TextColour.ERROR + "Bad argument, command should look like: " + DemConstants.TextColour.COMMAND + "/factionadmin flag <faction> set|remove <flag>";
                        }
                        break;
                    case "promote":
                        if (args.length > 1) {
                    ...
                    case "disband":
                        if (args.length > 1) {
                            ...
                            if (targetFaction == null) {
                                ...
                                if (fMan.disbandFaction(targetFaction, null))
